<template>
    <el-tabs style="width:100%" type="border-card">
        <el-tab-pane>
            ...
            <el-button type="primary" @click="goodsDialogVisible = true"><i class="el-icon-edit"></i>新增商品</el-button>
            <el-dialog :visible.sync="goodsDialogVisible">
                <el-form label-width="180px" ref="goodsData" :model="goodsData">
                    <el-form-item label="商品名称">
                        <el-select style="width:300px" v-model="goods" filterable placeholder="请选择"
                            @change="changeGoods(goods)">
                            <el-option v-for="item in goodsArr" :key="item._id" :label="item.goodsName"
                                :value="item._id">
                            </el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-table :data="shopGoods" style="width: 100%">
                ...
                <el-table-column prop="goodsTaste" label="口味">
                </el-table-column>
                <el-table-column prop="goodsRegion" label="产地">
                </el-table-column>
                <el-table-column prop="goodsTime" label="保质期">
                </el-table-column>
                <el-table-column prop="goodsPrice" label="价格">
                </el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button size="mini" type="danger" @click="removeGoodsOnShopAsync(scope.row)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-tab-pane>
            ...
            <el-dialog :visible.sync="centerDialogVisible">
                <el-form label-width="180px" ref="serData" :model="serData">
                    <el-form-item label="服务名称">
                        <el-select style="width:300px" v-model="value" filterable placeholder="请选择"
                            @change="changeSelect(value)">
                            <el-option v-for="item in serviceArr" :key="item._id" :label="item.serviceName"
                                :value="item._id">
                            </el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-table :data="shopService" style="width: 100%">
                ...
                <el-table-column prop="serviceCanFor" label="适用规格">
                </el-table-column>
                <el-table-column prop="serviceDetial" label="服务规格">
                </el-table-column>
                <el-table-column prop="serviceTime" label="耗时">
                </el-table-column>
                <el-table-column prop="servicePrice" label="价格">
                </el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button size="mini" type="danger" @click="removeServiceOnShopAsync(scope.row)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-tab-pane>
            ...
            <el-button type="primary" @click="petDialogVisible = true"><i class="el-icon-edit"></i>新增宠物</el-button>
            <el-dialog :visible.sync="petDialogVisible">
                <el-form label-width="180px" ref="petsData" :model="petsData">
                    <el-form-item label="宠物名称">
                        <el-select style="width:300px" v-model="pets" filterable placeholder="请选择"
                            @change="changePets(pets)">
                            <el-option v-for="item in petsArr" :key="item._id" :label="item.petName"
                                :value="item._id">
                            </el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-table :data="shopPets" style="width: 100%">
                ...
                <el-table-column prop="petType" label="宠物品类">
                </el-table-column>
                <el-table-column prop="petKind" label="宠物种类">
                </el-table-column>
                <el-table-column prop="petColor" label="颜色">
                </el-table-column>
                <el-table-column prop="petNature" label="性格">
                </el-table-column>
                <el-table-column prop="price" label="价格">
                </el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button size="mini" type="danger" @click="removePetsOnShopAsync(scope.row)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        computed: mapState(["shopEmployee", "serviceArr", "shopService", "goodsArr","shopGoods","petsArr","shopPets"]),
        methods: {
            ...mapActions(["updateShopAsync", "getEmployeeByShopIdAsync",
                "removeEmployeeByShopIdAsync", "getServicesByUserIdAsync", "addServiceIdOnShopsAsync",
                "getServiceByShopIdAsync", "removeServiceOnShopAsync", "getGoodsByUserIdAsync",
                "addGoodsIdOnShopsAsync","getGoodsByShopIdAsync","removeGoodsOnShopAsync","getPetsByUserIdAsync",
                "addPetsIdOnShopsAsync","getPetsByShopIdAsync","removePetsOnShopAsync"]),
            addEmp() {
